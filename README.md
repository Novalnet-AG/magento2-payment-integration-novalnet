...
Novalnet <a href="https://www.novalnet.de/"> merchant account </a> is required for processing all international and local payments through this Magento 2 Payment Gateway. The module is available for the magento versions 2.3.0 to 2.4.9 in the following languages: EN & DE
...
<a href="https://www.novalnet.de/modul/magento-2-payment/"> See here </a> for our link to demo magento store. Place your orders and test our trial checkout processes using our test credentials available in the login page of the <a href="https://magentov13.novaldemo.com/"> demo magento store </a>.
...
#### Follow the below steps and run each command from the shop root directory
 ...
 - Signup or login in the <a href="https://commercemarketplace.adobe.com/">Magento Marketplace </a>
 - Purchase the <a href="https://commercemarketplace.adobe.com/novalnet-module-payment.html"> Magento payment extension </a> by Novalnet for free
 - Upload the package content into the root directory
 - Upgrade, compile and deploy as explained in the section above
 
 ## Documentation
Find more about Magento module in: <a href="https://commercemarketplace.adobe.com/media/catalog/product/novalnet-module-payment-13-4-2-ce/installation_guides.pdf"> See here </a>
