...
Novalnet <a href="https://www.novalnet.de/"> merchant account </a> is required for processing all international and local payments through this Magento 2 Payment Gateway. The module is available for the magento versions 2.3.0 to 2.4.5-p1 in the following languages: EN & DE
...
#### Follow the below steps and run each command from the shop root directory
 ...
 ## Documentation
Find more about Magento module in: [https://marketplace.magento.com/media/catalog/product/novalnet-module-payment-13-0-0-ce/installation_guides.pdf](https://marketplace.magento.com/media/catalog/product/novalnet-module-payment-13-0-0-ce/installation_guides.pdf)<br>
