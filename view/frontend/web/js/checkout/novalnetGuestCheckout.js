    ...
    function($, Component, urlBuilder, storage, alert, quote, $t, totals, customerData, totalsDefaultProvider)
    {
        ...
        return Component.extend({
            ...
            initGuestCheckoutPage: function() {
                ...
                const guestGooglePayEnabled = window.checkoutConfig.payment.novalnetGooglepay.guest_page.novalnetGooglepay;
                if(guestGooglePayEnabled && paymentPage !== true) {
                ...
                const guestApplePayEnabled = window.checkoutConfig.payment.novalnetApplepay.guest_page.novalnetApplepay;
                if(guestApplePayEnabled && paymentPage !== true && window.ApplePaySession){
