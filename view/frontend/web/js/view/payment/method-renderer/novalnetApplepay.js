                                ...
                                if (response.result.status == "SUCCESS") {
                                    let serviceUrl = urlBuilder.build("/rest/V1/novalnet/payment/placeOrder", {}),
                                        payload = {
                                            ...
                                            billingAddress: (response.order.billing.contact) ? response.order.billing.contact : {},
                                            shippingAddress: (response.order.shipping.contact) ? response.order.shipping.contact : {},
                                            shippingMethod: {},
                                            isPaymentPage: true
                                        };
