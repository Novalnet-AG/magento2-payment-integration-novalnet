...
define(
    ...
    function (
        ...
        '#novalnetSepaGuarantee_account_number',
        function(event)
        {
            ...
            function(event)
        {
            var iban = $(this).val(),
                ...
                if (allowedCountries.includes(iban)) {
                    $('#novalnetSepaGuarantee_bic_code').addClass('required-entry');
                } else {
                    $('#novalnetSepaGuarantee_bic_code').removeClass('required-entry');
                }
        ...
        return Component.extend({
            ...
            getData: function () {
                ...
                return {
                    ...
                    'additional_data': {
                        'novalnetSepaGuarantee_account_holder': this.getAccountHolder(),
