    ...
    function (
        ...
        $(document).on('change','#novalnetSepaInstalment_cycle',function(){
         ...
         $(document).on(
            ...
            '#novalnetSepaInstalment_account_number',
            function(event)
        {
            if (this.id == 'novalnetSepaInstalment_account_number') {
            ...
            function(event)
        {
                var iban = $(this).val(),
                    ...
                    if (allowedCountries.includes(iban)) {
                        $('#novalnetSepaInstalment_bic_code').addClass('required-entry');
                    } else {
                        $('#novalnetSepaInstalment_bic_code').removeClass('required-entry');
                    }
        ...
        return Component.extend({
            ...
            getData: function () {
                ...
                return {
                    ...
                    'additional_data': {
                        'novalnetSepaInstalment_account_holder': this.getAccountHolder(),
             ...
             */
             getAccountHolder: function () {
                if (!this.getPaymentToken()) {
                    return $('#' + this.getCode() + '_account_holder').val();
                }
             },
            ...
            getAccountHolderName : function (){
                return window.checkoutConfig.payment[this.getCode()]?.accountHolderName;
            },
