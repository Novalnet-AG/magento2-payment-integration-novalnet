            ...
            function(event)
        {
            var iban = $(this).val(),
                ...
                if (allowedCountries.includes(iban)) {
                    $('#novalnetSepa_bic_code').addClass('required-entry');
                } else {
                    $('#novalnetSepa_bic_code').removeClass('required-entry');
                }
        ...
        return Component.extend({
            ...
            getData: function () {
                return {
                    ...
                    'additional_data': {
                        'novalnetSepa_account_holder' : this.getAccountHolder(),
