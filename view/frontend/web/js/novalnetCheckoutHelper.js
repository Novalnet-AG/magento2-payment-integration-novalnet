         ...
         return {
           ...
           /**
            ...
            initMiniCart: function(miniCartQuote) {
                ...
                if(miniCartQuote.isEnabled.novalnetGooglepay){
                ...
                if(miniCartQuote.isEnabled.novalnetApplepay && window.ApplePaySession){
            ...
            initProductPage: function(isProductVirtual, productPageQuote) {
                ...
                if(productPageQuote.isEnabled.novalnetGooglepay){
                                const googlePayInstance = NovalnetPayment().createPaymentObject();
                ...
                if(productPageQuote.isEnabled.novalnetApplepay && window.ApplePaySession){
                    const applePayInstance = NovalnetPayment().createPaymentObject();
            ...
            /**
             * Init google pay cart page express checkout button
             *
             * @param cartPageQuote
             * @see Novalnet/Payment/view/frontend/templates/checkout/CartPageShortcut.phtml
             */
            initGooglePayCartPage: function(cartPageQuote) {
                const self = this,
            ...
            /**
             * Init apple pay cart page express checkout button
             *
             * @param cartPageQuote
             * @see Novalnet/Payment/view/frontend/templates/checkout/CartPageShortcut.phtml
             */
            initApplePayCartPage: function(cartPageQuote) {
                const self = this,
