    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        try {
            ...
            if (preg_match('/novalnet/', $paymentMethodCode)) {
                ...
                if ($this->novalnetRequestHelper->isAdmin() && (preg_match('/order_create/i', $this->urlInterface->getCurrentUrl()) || preg_match('/ordercapture/i', $this->urlInterface->getCurrentUrl()))) {
