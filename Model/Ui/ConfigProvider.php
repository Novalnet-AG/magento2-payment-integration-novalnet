...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    ...
    public const NOVALNET_TWINT = 'novalnetTwint';
        ...
        return [
            'payment' => [
                ...
                self::NOVALNET_APPLEPAY => [
                    ...
                    'isZeroAmountBooking' => ($this->novalnetConfig->getPaymentConfig(self::NOVALNET_APPLEPAY, 'payment_action') == NNConfig::ACTION_ZERO_AMOUNT_BOOKING) ? true : false
                ...
                self::NOVALNET_GOOGLEPAY => [
                    ...
                    'isZeroAmountBooking' => ($this->novalnetConfig->getPaymentConfig(self::NOVALNET_GOOGLEPAY, 'payment_action') == NNConfig::ACTION_ZERO_AMOUNT_BOOKING) ? true : false
                ...
                self::NOVALNET_SEPA => [
                    ...
                    'accountHolderName' => $this->novalnetRequestHelper->getAccountHolder()
                ...
                self::NOVALNET_TWINT => [
                    'logo' => $this->getPaymentLogo(self::NOVALNET_TWINT),
                    'testmode' => $this->novalnetConfig->getTestMode(self::NOVALNET_TWINT),
                    'instructions' => $this->novalnetConfig->getPaymentConfig(self::NOVALNET_TWINT, 'instructions')
                ],
        ...
        if ($customerSession->isLoggedIn() && $this->novalnetConfig->getPaymentConfig($paymentMethodCode, 'shop_type')) {
            ...
            foreach ($transactionStatusCollection as $key => $transactionStatus) {
                if ($transactionStatus->getTokenInfo() && !empty(json_decode($transactionStatus->getTokenInfo(), true))) {
                    ...
                    if (!empty($tokenInfo['NnSubscription'])) {
                        continue;
                    }
